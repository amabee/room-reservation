...
import { Edit, Search, Image, X } from "lucide-react";
...
export const UpdateRoomModal = ({
  ...
  // If modal is not open or no current room, return null
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={updateRoomForm.name}
                  onChange={handleUpdateRoomInputChange}
                  required
                  className={cn(
              ...
              <div className="space-y-3 md:col-span-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-xs bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 px-2 py-1 rounded-full">
                    {updateRoomForm.facilities.length} selected
                  </div>
                </div>
                    ...
                    filteredFacilities.map((facility) => (
                      <div
                        ...
                        className={cn(
                          ...
                          updateRoomForm.facilities.includes(
                      ...
                      >
                        <Checkbox
                          ...
                          checked={updateRoomForm.facilities.includes(
                            facility.facility_id
                          )}
                          onCheckedChange={() =>
                ...
                {updateRoomForm.facilities.length > 0 && (
                  <div
                    className={cn(
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-1">
                      {updateRoomForm.facilities.map((facilityId) => {
