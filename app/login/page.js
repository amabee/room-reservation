...
export default function LoginPage() {
  ...
  <img 
    src="/psalogoo.png" 
    alt="Logo"
    className="w-4/5 h-auto object-contain ml-32"  // Added margin-left to move it right
  />
</div>
      ...
      <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-2/5 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
        <div className="w-full h-100">
          ...
          <h1 className="text-xl md:text-2xl font-bold leading-tight mt-8">Log in to your account</h1>
          ...
          <p className="text-sm text-gray-500 mt-12">&copy; 2025 Room Reservation - All Rights Reserved.</p>
        </div>
      </div>
    </section>
  );
